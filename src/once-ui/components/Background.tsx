...
import Aurora from '@/blocks/Backgrounds/Aurora/Aurora'; // Add this import
...
interface BackgroundProps extends React.ComponentProps<typeof Flex> {
  ...
  lines?: LinesProps;
  mask?: MaskProps;
  aurora?: AuroraProps; // Add aurora prop
  className?: string;
  ...
  (
    {
      ...
      lines = {},
      mask = {},
      aurora = {}, // Add default empty aurora object
      children,
      className,
      style,
      ...rest
    ...
    return (
      <Flex
        ...
        {...rest}
      >
        {/* Add Aurora component */}
        {aurora.display && (
          <Flex position="absolute" top="0" left="0" fill pointerEvents="none" zIndex={-1}>
            <Aurora
              colorStops={aurora.colorStops || ['#3A29FF', '#FF94B4', '#FF3232']}
              blend={aurora.blend || 0.5}
              amplitude={aurora.amplitude || 1.0}
              speed={aurora.speed || 0.5}
            />
          </Flex>
        )}
